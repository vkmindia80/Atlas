...
flexGrow: number | (string & {}) | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset";
...
onBeforeToggle?: ToggleEventHandler<HTMLDivElement> | undefined;
...
export declare function List<RowProps extends object, TagName extends TagNames = "div">({ children, className, defaultHeight, listRef, onResize, onRowsRendered, overscanCount, rowComponent: RowComponentProp, rowCount, rowHeight, rowProps: rowPropsUnstable, tagName, style, ...rest }: ListProps<RowProps, TagName>): ReactElement<    {
className: string | undefined;
ref: Dispatch<SetStateAction<HTMLDivElement | null>>;
style: {
accentColor?: Property.AccentColor | undefined;
